...
import os
import random
import SummaryTab, FileTab, ImagesTab, NewCaseDialog, mainmenu, search, searchTab, AnalyzedDataTab      
import connectdb
import subprocess
import sqlite3
...
class mainFrame(wx.Frame):
    ...
    def addAuiTab(self, tabName, evidenceDetails):
        ...
        if tabName == "Images":
            ...
            addingPage = self.auiNotebook.AddPage(ImagesTab.TabPanel(self.auiNotebook, tabName, evidenceDetails, caseDir, caseDbPath), tabName, False, wx.NullBitmap)
